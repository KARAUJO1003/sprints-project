    ...
    return (
      <div className="group relative flex mt-auto w-full h-8">
        <Input
          ...
          value={columnFilterValue ?? ""}
          onChange={(e) => column.setFilterValue(e.target.value)}
          className="bg-transparent focus-visible:bg-muted-foreground/5 focus-visible:shadow-inner pr-0 border-none rounded-none outline-none focus-visible:ring-none focus-visible:ring-0 focus-visible:ring-offset-none w-full h-full font-normal"
        />
      </div>
    );
  }
